      ...
      <div style={{ position: "relative", height: 220, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(0deg,rgba(10,14,26,0.75) 0%,transparent 55%)",
          }}
        />
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <a
            href={`https://wa.me/254${l.landlord?.phone?.replace(
              /^0/,
              ""
            )}?text=Hi, I found your listing on Edira: ${l.title}. Is it still available?`}
            target="_blank"
            rel="noreferrer"
